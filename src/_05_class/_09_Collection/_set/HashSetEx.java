...
public class HashSetEx {
    public static void main(String[] args) {
        ...
        set1.add("banana");
        set1.add("kiwi");
        // set1.add("banana"); // 중복 객체 -> Set 에서 저장 안 됨
        System.out.println(set1); // [banana, apple, kiwi] 순서가 상관 없음

        // 저장된 객체 개수 출력
        int size1 = set1.size();
        System.out.printf("총 %d 종류의 과일이 있습니다. %n%n", size1).println();
        ...
        // 저장된 객체 개수 출력
        int size2 = set2.size();
        System.out.printf("총 %d 종류의 과정이 있습니다. %n%n", size2).println();
